...
interface MyPlantsDAO {
    ...
    @Query("Update table_my_plants Set nickName = :nickName, lastWater = :lastWater, sun = :sun, temperature = :temperature WHERE pEngName = :pEngName ")
    fun updateMyPlant(nickName: String,lastWater: String, sun: String, temperature:String,pEngName: String)
